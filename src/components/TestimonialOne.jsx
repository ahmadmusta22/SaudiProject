...
const TestimonialOne = () => {
  return (
    <div
      className="testimonial-area-1 overflow-hidden mt-5"
          ...
          <div className="col-lg-6">
            <div className="space">
              <div className="title-area">
                <span className="sub-title">اراء المتدربين</span>
...
احمد حسين                               </h4>
                          ...
                          "التدريب في المعهد كان تجربة رائعة ومفيدة للغاية. البيئة التعليمية محفزة، والمدربون يتمتعون بخبرة كبيرة ويحرصون على توصيل المعلومات بطريقة عملية وتفاعلية. استفدت كثيرًا من الورش والتطبيقات العملية التي ساعدتني على تطوير مهاراتي بشكل ملحوظ. أوصي به لأي شخص يبحث عن تعلم حقيقي وتجربة تدريبية مميزة."
